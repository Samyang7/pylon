...
get_ipython().system('cat ./container-serving/build_tools/build_and_push.sh')
...
get_ipython().run_cell_magic('time', '', '! ./container-serving/build_tools/build_and_push.sh us-east-1')
...
tensorpack_image = '122783958501.dkr.ecr.us-east-1.amazonaws.com/mask-rcnn-tensorpack-serving-sagemaker'
...
get_ipython().system('cat ./container-serving-optimized/build_tools/build_and_push.sh')
...
get_ipython().run_cell_magic('time', '', '! ./container-serving-optimized/build_tools/build_and_push.sh us-east-1')
...
aws_samples_image = '122783958501.dkr.ecr.us-east-1.amazonaws.com/mask-rcnn-tensorflow-serving-sagemaker'
...
get_ipython().system('wget -O ./test2017.zip http://images.cocodataset.org/zips/test2017.zip')
...
get_ipython().system('unzip -q ./test2017.zip')
get_ipython().system('rm  ./test2017.zip')
